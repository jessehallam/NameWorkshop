...
(function() {
  var CapitalExpression, ConstantExpression, EvaluationExpression, ExpressionBase, ExpressionBranch, ExpressionList, ItemExpression, ItemsExpression, Lexer, NameLookupExpression, Parser, RangeExpression, RepeatExpression, getRandom, lexStates,
  ...
  EvaluationExpression = (function(_super) {
    ...
    function EvaluationExpression(item) {
      this.item = item;
    }
  ...
  Parser = (function() {
    ...
    Parser.prototype.$readExpression = function() {
      var cap, exp, rep;
      cap = this.$expect('^');
      exp = this.$readRangeExpression() || this.$readNamedExpression() || this.$readGroupExpression() || this.$readConstantExpression();
      if (!exp) {
        return;
      }
